    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-600 mb-8">Đăng nhập để tiếp tục hành trình của bạn</p>
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <div className="absolute inset-0 bg-gradient-to-br from-sky-500 via-violet-500 to-orange-500"></div>
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-center text-white">
            <h2 className="text-4xl font-bold mb-4">Khám phá thế giới</h2>
            <p className="text-xl text-white/80">Hàng ngàn điểm đến đang chờ bạn</p>
          </div>
        </div>
      </div>
    </div>
